...
EXTERN void credit_user_time(void);
...
EXTERN void medival_times_who(UR_OBJECT);
EXTERN void camelot_who(UR_OBJECT);
...
EXTERN void rebuild_userlist(UR_OBJECT);
EXTERN void create_bot(void);
EXTERN void brand_user(UR_OBJECT, char *);
EXTERN void unbrand_user(UR_OBJECT);
EXTERN void capture(UR_OBJECT);
EXTERN void shackles_who(UR_OBJECT);
EXTERN void dark_garden_who(UR_OBJECT);
EXTERN char *strrep(char *, char *, char *, size_t);
EXTERN char *wordrep(char *, char *, char *);
EXTERN void trivia_banner(UR_OBJECT);
EXTERN void trivia_start_stop(UR_OBJECT);
EXTERN void trivia_win(UR_OBJECT);
...
EXTERN void dictionary(UR_OBJECT, char*);
EXTERN void steal_user_money(UR_OBJECT);
EXTERN void spin(UR_OBJECT);
EXTERN void flip_coin(UR_OBJECT);
EXTERN void roll_dice(UR_OBJECT);
EXTERN void fight_another(UR_OBJECT, char *);
EXTERN int get_odds_value(UR_OBJECT);
EXTERN int determ_rand(UR_OBJECT, UR_OBJECT);
EXTERN void issue_chal(UR_OBJECT, UR_OBJECT);
EXTERN void accept_chal(UR_OBJECT);
EXTERN void reset_chal(UR_OBJECT, char *);
EXTERN void clear_fight_record(UR_OBJECT);
EXTERN void russian_roulette(UR_OBJECT);
EXTERN void paintball(UR_OBJECT, char *);
EXTERN void paintball_reload(UR_OBJECT);
EXTERN void eight_ball(UR_OBJECT, char *);
EXTERN void mutter(UR_OBJECT, char *);
EXTERN void clear_mutterrevbuff(void);
EXTERN void record_mutter(char *);
EXTERN void mutrevclr(UR_OBJECT);
